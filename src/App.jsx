...
export default function App(){
  ...
  return(
    <div style={{fontFamily:"'Inter',-apple-system,sans-serif",minHeight:"100vh",background:T.surfaceAlt,color:T.text,display:"flex"}}>
      {!mob&&<div style={{width:240,background:T.sidebar,minHeight:"100vh",flexShrink:0,borderRight:"1px solid "+T.sidebarBorder}}><SidebarContent/></div>}
      {mob&&sidebarOpen&&(<div style={{position:"fixed",inset:0,zIndex:50,display:"flex"}}><div style={{width:240,background:T.sidebar,height:"100vh",borderRight:"1px solid "+T.sidebarBorder}}><SidebarContent/></div><div style={{flex:1,background:"rgba(0,0,0,0.5)"}} onClick={()=>setSidebarOpen(false)}/></div>)}
      <div style={{flex:1,display:"flex",flexDirection:"column",minWidth:0}}>
        ...
        <div style={{flex:1,overflow:"auto",padding:mob?14:"26px 32px"}}>
          <div style={{maxWidth:page==="gantt"?"100%":page==="dashboard"?1400:page==="ranking"||page==="chat_docs"||page==="chat_ai"?1100:900,margin:"0 auto",width:"100%"}}>
